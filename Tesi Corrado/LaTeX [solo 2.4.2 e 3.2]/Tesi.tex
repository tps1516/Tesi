...
Come nel caso della versione VARForecaster 2.1, i sensori inattivi rappresentano un eventuale problematica da dover gestire. 
...
Per la gestione di (2), per lo stesso motivo sopracitato, si è preferito far ripartire il processo di smoothing dal "passo base" e quindi di clonare il sensore reale.
...
Nella fase di crescita incrementale dell'albero questo vuol dire che non soltanto la fase di drift ha subito modifiche ma anche quella di potatura. Infatti questa fase deve applicare l'operatore di pruning sulla base dei valori predetti presenti in \textit{snapSmoot} di \textit{t-1}.
\newpage
