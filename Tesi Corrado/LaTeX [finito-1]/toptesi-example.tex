...
\titolo{Apprendimento incrementale di cluster spazio temporali per la costruzione del modello VAR}% per la laurea quinquennale e il dottorato
...
\candidato{\tabular{@{}l@{}}Donato Mastropasqua\\Matricola: 573658\endtabular}% per tutti i percorsi
