...
public abstract class Feature implements Serializable, Cloneable{
	...
	public abstract void computeAutocorrelation(AutocorrelationI a, SnapshotData data, SnapshotWeigth W, int beginIndex, int endIndex);
	...
	//abstract public void setPrototype(SnapshotData data, SnapshotWeigth W, int beginIndex, int endIndex) ;
