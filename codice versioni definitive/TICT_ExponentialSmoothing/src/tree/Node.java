...
public abstract class Node implements Serializable {
	...
	public Node(AutocorrelationI a, SnapshotData trainingSet,
		...
		for (Feature f : this.getSchema().getTargetListNotLeaf()) {
			...
			if (a != null) {
				f.computeAutocorrelation(a, snapSmoot, W, beginExampleIndex,
						endExampleIndex);
	...
	Map<Integer, ErrorStatistic> estimateGetisAndOrdError(int begin, int end) {
	...
	void update(SnapshotData trainingSet, SnapshotData snapSmoot,
			AutocorrelationI a, SnapshotWeigth W, int beginExampleIndex,
			int endExampleIndex) {
		this.beginExampleIndex = beginExampleIndex;
		this.endExampleIndex = endExampleIndex;
